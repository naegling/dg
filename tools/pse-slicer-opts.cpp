...
SlicerOptions parseSlicerOptions(int argc, char *argv[]) {
  ...
  llvm::cl::opt<LLVMReachingDefinitionsAnalysisOptions::AnalysisType> rdaType("rda",
                                                                              llvm::cl::desc(
                                                                                  "Choose reaching definitions analysis to use:"),
                                                                              llvm::cl::values(
                                                                                  clEnumValN(
                                                                                      LLVMReachingDefinitionsAnalysisOptions::AnalysisType::dense,
                                                                                      "dense",
                                                                                      "Dense RDA (default)"),
                                                                                  clEnumValN(
                                                                                      LLVMReachingDefinitionsAnalysisOptions::AnalysisType::ss,
                                                                                      "ss",
                                                                                      "Semi-sparse RDA")
                                                                              ),
                                                                              llvm::cl::init(
  ...
  llvm::cl::opt<dg::CD_ALG> cdAlgorithm("cd-alg",
                                        ...
                                        llvm::cl::values(
                                            clEnumValN(dg::CD_ALG::CLASSIC,
                                                       "classic",
                                                       "Ferrante's algorithm (default)"),
                                            clEnumValN(dg::CD_ALG::CONTROL_EXPRESSION,
                                                       "ce",
